...
def parse_command_line():
    ...
    allowed_params = ["temperature", "humidity", "windspeed","flash"]
...
def interpolate(grid, points, background, obs, args):
    ...
    structure = gridpp.BarnesStructure(50000, 200) # 
    ...
    obs_to_background_variance_ratio = np.full(points.size(), 0.01) # oli 0.1!!! from 0.01 --> # David 0.75 ??? --> 0.99
